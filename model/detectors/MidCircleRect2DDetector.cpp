...
MidCircleRect2DDetector::MidCircleRect2DDetector(unsigned half_width,
		...
		MidCircleRect2DDetector(half_width, nbr_of_potential_src,
				...
				half_inter_potential_srcs_dist, potential, 2, 10000, 10e-12){}
...
MidCircleRect2DDetector::MidCircleRect2DDetector(unsigned half_width,
	...
	MyGridGenerator<2>::rectangle_with_circular_holes(*triangulation, half_width,
	...
	boundary_conditions = new MidCircleRect2DBoundaryCond<2>(half_width,
			potential, nbr_of_potential_src, half_inter_potential_srcs_dist);
	...
	MyGridGenerator<2>::rectangle_with_circular_holes(*triangulation_weight, half_width,
					potential_src_radius, half_inter_potential_srcs_dist,
					nbr_of_potential_src);
	boundary_conditions_weight = new MidCircleRect2DBoundaryCondWeight<2>(half_width,
...
std::string MidCircleRect2DDetector::params_to_string() {
	...
	+ "_nbr_of_potential_src_"
			+ std::to_string(nbr_of_potential_src) +"_potential_src_radius_"
			+ std::to_string(potential_src_radius) + "_half_inter_potential_srcs_dist_"
