	...
	\subsection{Comparison with \textit{Weightfield}}
		...
		\begin{figure}[H]
			...
			\caption{Weighting potential inside the detector, given by \textit{Pdetect} with pitch 
				of 450$\mu$m, strip length of 100$\mu$m, detector width of 300$\mu$m.}
		...
		\begin{figure}[H]
			\begin{minipage}[b]{.46\linewidth}
				...
				\caption{Weighting potential along a vertical line passing in the middle of the detector,
						given by \textit{Weightfield} with pitch of 450$\mu$m, strip length of 100$\mu$m,
			...
			\center
				...
				\caption{Weighting potential along a vertical line passing in the middle of the detector,
						given by \textit{Pdetect} with pitch of 450$\mu$m, strip length of 100$\mu$m, detector
						width of 300$\mu$m.}
