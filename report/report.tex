...
This section is composed of three parts. Firstly,
 ...
 is presented.
	...
	In order to avoid to reinvent the wheel, it has been decided to use the deal.ii library
	to solve the Laplace equation~\cite{Bangerth:2007:DGO:1268776.1268779}. This decision allows to rely on the optimized
	and robust code of deal.ii and to benefit from the state of
	the art numerical methods it offers.
