...
\section{Discussion and applications}
	...
	\subsection{Comparison with \textit{Weightfield}}
		...
		\begin{figure}[H]
			\center
			\includegraphics[scale=0.62]{images/boundary_conditions/detector/weight_free.png}
		...
		\begin{figure}[H]
			\center
			\includegraphics[scale=0.4]{images/boundary_conditions/detector/w_free_conditions.png}
