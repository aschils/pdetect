			...
			\begin{minipage}[b]{.60\linewidth}
				\begin{tikzpicture}
				    \begin{axis}[
				        ...
				        enlargelimits=false,
				        axis on top]
				        \addplot graphics[xmin=0,xmax=400,ymin=0,ymax=300] {images/boundary_conditions/detector/w_semi_free_conditions.png};
				    \end{axis}
				\end{tikzpicture}
			\end{minipage}
			...
			\begin{minipage}[b]{.60\linewidth}
				\begin{tikzpicture}
				    \begin{axis}[
				        ...
				        enlargelimits=false,
				        axis on top]
				        \addplot graphics[xmin=0,xmax=400,ymin=0,ymax=300] {images/boundary_conditions/detector/w_free_conditions.png};
				    \end{axis}
				\end{tikzpicture}
			\end{minipage}
			\begin{minipage}[b]{.46\linewidth}
