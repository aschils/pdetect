...
Current computation algorithm accesses $\vec{E}(x,y)$ and $\vec{E}_w(x,y)$ very
often $\implies$ access must be fast
\newline
...
$\implies$ use \textcolor{red}{rtree} data structure allows to access the right
...
\begin{itemize}
  ...
  \item Townsend avalanche phenomena implementation needs to b
\end{itemize}
