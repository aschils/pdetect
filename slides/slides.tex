...
\begin{frame}
  ...
  inter-strips distance = 50 $\mu$m, max relative error = 0.9$\%$
...
\begin{frame}
  ...
  Detector width = 200 $\mu$m, strip length = 50 $\mu$m, strip width = 50 $\mu$m,
	inter strips distance = 50$\mu$m, number of strips = 3, potential = 10V,
  ...
  \begin{columns}
      \begin{column}{0.5\textwidth}
        ...
        \begin{center}
          ...
          \includegraphics[width=\textwidth, height=5cm]{images/weight_free.png}
        \end{center}
      \end{column}
      ...
      \begin{column}{0.5\textwidth}
        \begin{center}
          ...
          \includegraphics[width=\textwidth, height=5cm]{images/w_free_conditions.png}
        \end{center}
