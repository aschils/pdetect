...
\vspace{-1em}
  ...
  $\implies$  \textcolor{red}{avoids code duplication}

  $\implies$ \textcolor{red}{add features} to a module with \textcolor{red}{few modifications} to other
  modules

  $\implies$ improve code \textcolor{red}{readability}
